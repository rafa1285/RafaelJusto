...
public class Nuevo {
	...
	// REDIRECCIONES A PAGINAS. CON LAS TILES LE PONEMOS EL NOMBRE QUE ESTA ASOCIADO A LA RUTA CORRESPONDIENTE
...
//			model.addAttribute(ATT_LISTA_PACIENTE, p.getCitas());
			//model.addAttribute(ATTpacienteSvc.buscar(id));
...
//	@RequestMapping(value = "/nuevaCita", method = RequestMethod.GET)
//	public String viewNuevaCita(@ModelAttribute Paciente paciente, Model model) {
//		try {
//			// Incluir elementos para la seleccion
//			model.addAttribute(ATT_LISTA_TERAPEUTAS, terapeutaSvc.listar());
//			return SUCCESS_NUEVA_CITA;
//		} catch (Exception e) {
//			model.addAttribute(ATT_ERROR, e);
//			return ERROR_NUEVA_CITA;
//		}
//	}
