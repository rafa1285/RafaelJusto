...
public class Listar {
	...
	/**
	 * Busca las citas que tiene asignada un paciente y todas las que ha tenido.
	 * 
	 * @param id
	...
	/**
	 * Busca las citas que tiene asignada un terapeuta
	 * 
	 * @param id
	...
	public String executeDiagnosticoPaciente(@RequestParam int id, Model model) {
		try {
//			Paciente p = pacienteSvc.buscar(id);
//			model.addAttribute(ATT_ITEM_PACIENTE, p.getDiagnosticos());
