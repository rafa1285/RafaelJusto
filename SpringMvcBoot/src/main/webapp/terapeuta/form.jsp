...
<%@ taglib prefix="fmt" uri="http://java.sun.com/jsp/jstl/fmt" %>
	...
	<form:form class="form-signin" modelAttribute="terapeuta" method="POST" action="guardarTerapeuta">
		...
		<form:select path="especialidad_id.id_especialidad" items="${listaEspecialidad}" itemLabel="especialidad" itemValue="id_especialidad"/>
		
		<label for="tipoUsuario" class="sr-only"><spring:message code="terapeuta.tipo_usuario_id"/></label>
		<form:select path="tipoUsuario.id_tipo" items="${listaTipoUsuario}" itemLabel="tipo" itemValue="id_tipo"/>
