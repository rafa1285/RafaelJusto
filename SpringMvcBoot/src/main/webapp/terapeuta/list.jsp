...
<h1>LISTADO DE TERAPEUTAS</h1>
	<table class="table table-bordered">
		...
		<c:forEach items="${listaTerapeuta}" var="item">
			<tr>
				...
				<td><a href="buscarTerapeutaEditar?id=${item.id_empleado}"><spring:message code="accion.editar"/></a></td>	
				<td><a href="borrarTerapeuta?id=${item.id_empleado}" onclick="return confirm('<spring:message code="accion.confirmar"/>');"><spring:message code="accion.eliminar"/></a></td>	
	...
	<br>
	<a href="nuevoTerapeuta"><spring:message code="accion.inicio"/></a>
</body>
</html>